      ...
      <div className="exam-info-page">
        ...
        <div className="exam-info-content">
          ...
          <section className="info-section">
            <h3>📝 필기 시험</h3>
            <p>
              객관식 4지선다형 문제로 출제되며, OSI 7계층, TCP/UDP 포트 번호, 네트워크 장비, 명령어, 케이블 종류 등 암기 중심의 전통적인 문제가 많습니다.
            </p>
          </section>
          ...
          <section className="info-section">
            <h3>💻 실기 시험</h3>
            <p>
              서술형 및 구성도 작성 형태로, 실제 네트워크 구성 및 운영 능력, 윈도우/리눅스 명령어 사용 능력, IP 주소 계산 및 라우터 설정에 대한 실무 감각을 평가합니다.
            </p>
          </section>
          ...
          <section className="info-section tips">
            ...
            <ul className="tips-list">
              ...
              <li>
                <strong>실수 허용치:</strong> 각 파트별 실수 허용치가 적고, 모든 영역에서 골고루 점수를 획득해야 안정적인 합격이 가능합니다.
              </li>
              <li>
                <strong>케이블 제작 (1번):</strong> 실기 중 유일하게 직접 손으로 만드는 작업이며, 정확한 색상 순서, 테스터기 작동 여부까지 확인하므로 사전 연습이 매우 중요합니다.
              </li>
              <li>
                <strong>윈도우 설정 (2~9번):</strong> GUI 기반 설정 문제로, 정확한 IP 주소, 서브넷 마스크, 게이트웨이 입력이 필요합니다.
              </li>
              <li>
                <strong>리눅스 명령어 (10~15번):</strong> 기본 명령어와 네트워크 관련 명령어를 숙지해야 합니다.
              </li>
              <li>
                <strong>라우터 설정 (16~18번):</strong> 라우팅 테이블 작성, IP 및 서브넷 설정, 게이트웨이 구성 등이 포함되며, Router Emulator 프로그램을 통해 실습합니다.
              </li>
            </ul>
          </section>
          ...
          <section className="info-section warning">
            ...
            <ul className="warning-list">
              <li>모든 문제는 정확도가 중요하며, 오타나 띄어쓰기 실수도 감점 대상이 될 수 있습니다.</li>
              <li>시간 배분이 중요합니다. 각 문제 유형별로 충분한 연습을 통해 시간 감각을 익히세요.</li>
              <li>실기 시험장에는 필기구와 수험표만 지참 가능하며, 별도의 계산기나 참고 자료는 사용할 수 없습니다.</li>
            </ul>
          </section>
